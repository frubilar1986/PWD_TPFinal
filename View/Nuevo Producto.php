        ...
        <?php if (isset($producto)) { ?>
          ...
          <div id="contenedor-imagenes">
            ...
            <?php if (count($arrImagenes) > 2) { ?>
              <br>
              <a type="button" href="borrarImagenes.php?id=<?= $producto->getIdProducto() ?>" class="btn btn-labeled btn-danger mt-3" onclick="requerirImagen()" rel="nofollow" target="_blank">
