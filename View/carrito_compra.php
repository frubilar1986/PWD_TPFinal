        ...
        <div class="compra d-flex justify-content-between mt-5">
          ...
          <div class="d-flex">
            ...
            <div class="d-flex flex-column">
              ...
              <a href="eliminarAccion.php?id=<?= $producto[0]->getIdProducto(); ?>" class="mt-2">Eliminar</a>
            </div>
          </div>
          ...
          <div>
            <form class="needs-validation" novalidate action="cambiarCantidadAccion.php">
              <div class="formCantidad2 mb-3">
                <!-- ID PRODUCTO OCULTO -->
                <input name="idProd" for="idProd" type="number" class="form-control" style="display: none;" placeholder="<?= $producto[0]->getIdProducto(); ?>" value=<?= $producto[0]->getIdProducto(); ?>>

                <!-- CANTIDAD -->
                <div id="padreInput">
                  <input name="cantidadProd" for="cantidadProd" type="number" class="form-control inputCantidad" id="cantidadProducto" placeholder="Cantidad: <?= $arrProducto["cantidadProducto"] ?>" min="0" max="<?= $producto[0]->getProCantStock(); ?>" value=<?= $arrProducto["cantidadProducto"] ?>>
