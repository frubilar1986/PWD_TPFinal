...
$proCarrito = $control->productosCarrito();
...
<div class="container border mt-5">
  ...
  <div class="m-3">
    ...
    <?php foreach ($proCarrito as $producto) { ?>
      <div class="compra d-flex justify-content-between mt-5">
        ...
        <div class="d-flex">
          ...
          <div class="d-flex flex-column">
            <p class="fw-bold"><?= $producto->getProNombre(); ?></p>
        ...
        <div class="precio">
          <p>$<span id="precio-compra" class="precio-compra">
              <?php

              $precio = ($producto->getProPrecioOferta() != null) ? $producto->getProPrecioOferta() : $producto->getProPrecio();
              echo $precio;
              ?>
