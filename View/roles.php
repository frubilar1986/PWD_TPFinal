...
<br><br>
<div class='container '>
    <h2 class="text-danger">Debe seleccionar el registro para realizar cambios</h2>
    <table id="dgRol" title="Roles" class="easyui-datagrid  " style="width:650px;height:300px ; " url="accion/listarRoles.php" toolbar="#toolbarRol" pagination="true" rownumbers="true" fitColumns="true" singleSelect="true">
        <thead>
            <tr>
    ...
    <!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
    <table id="dg" title="Alta Baja Modif de menus" class="easyui-datagrid  " style="width:650px;height:500px ; " url="accion/listarUsRol.php" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true" singleSelect="true">
        <thead>
            <tr>
