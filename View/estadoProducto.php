            ...
            <tr>
              ...
              <td>
                <?php if (!$producto->getProDeshabilitado()) { ?>
                  <a class="btn btn-danger mt-3" title="Dar de baja" href="./estadoProductoAccion.php?id=<?= $producto->getIdProducto() ?>&v=1" role="button"><i class="fas fa-trash-alt"></i></a>
                <?php } else { ?>
                  <a class="btn btn-warning mt-3" title="Reactivar" href="./estadoProductoAccion.php?id=<?= $producto->getIdProducto() ?>&v=1" role="button"><i class="fas fa-redo"></i></a>
                <?php } ?>
              </td>
